...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-blue-50 text-gray-900 overflow-x-hidden">
      <Header />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 lg:mb-12">
              <span className="inline-block px-4 py-2 lg:px-6 lg:py-3 bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 rounded-full text-xs lg:text-sm font-semibold mb-6 lg:mb-8 shadow-lg">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold mb-4 lg:mb-6">
                About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-600">Shiv Enterprises</span>
              </h1>

              <p className="text-base lg:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mt-8 lg:mt-12">
                <div className="relative group bg-gradient-to-br from-white to-blue-50 rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-lg lg:text-xl font-bold mb-2 lg:mb-3 text-gray-900">
                    Our Mission
                  </h3>
                ...
                <div className="relative group bg-gradient-to-br from-white to-emerald-50 rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
              <div className="relative rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl group">
                <div className="aspect-[4/3] relative overflow-hidden">
                  ...
                  {/* TOP BADGE */}
                  <div className="absolute top-4 left-4 lg:top-6 lg:left-6 bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-3 py-1 lg:px-5 lg:py-2 rounded-full text-xs lg:text-sm font-semibold shadow-lg">
                    Infrastructure Experts
                  </div>

                  {/* BOTTOM BADGE */}
                  <div className="absolute bottom-4 right-4 lg:bottom-6 lg:right-6 bg-gradient-to-r from-emerald-600 to-green-600 text-white px-3 py-1 lg:px-5 lg:py-2 rounded-full text-xs lg:text-sm font-semibold shadow-lg">
              ...
              {/* FLOATING CARD */}
              <div className="absolute -bottom-4 -left-4 lg:-bottom-6 lg:-left-6 bg-gradient-to-r from-blue-600 to-emerald-600 text-white p-4 lg:p-6 rounded-xl lg:rounded-2xl shadow-2xl transform -rotate-3 animate-float">
                <div className="flex items-center gap-2 lg:gap-3">
                  <FaTrophy className="text-xl lg:text-2xl" />
                  <div>
                    <div className="text-lg lg:text-2xl font-bold">5+ Years</div>
                    <div className="text-xs lg:text-xs opacity-90">
                      Industry Experience
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
            {achievements.map((achievement, index) => (
              <div key={index} className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl lg:rounded-2xl blur-xl"
                  style={{ backgroundImage: `linear-gradient(to right, ${achievement.color.split(' ')[1]}, ${achievement.color.split(' ')[3]})` }}>
                </div>

                <div className="relative bg-white rounded-lg lg:rounded-xl p-4 lg:p-8 text-center border border-gray-200 group-hover:border-transparent shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className={`inline-flex p-2 lg:p-4 rounded-lg bg-gradient-to-r ${achievement.color} mb-2 lg:mb-4 shadow-md`}>
                    <achievement.icon className="text-lg lg:text-2xl text-white" />
                  </div>

                  <div className="text-xl md:text-2xl lg:text-4xl font-bold mb-1 lg:mb-2 text-gray-900">
                    {achievement.number}
                  </div>

                  <p className="text-gray-600 text-xs lg:text-sm">{achievement.label}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {coreValues.map((value, index) => (
              ...
              >
                ...
                <div className="p-4 lg:p-6 relative z-10">
                  <div className="text-3xl lg:text-4xl mb-2 lg:mb-4">{value.icon}</div>
                  <h3 className="text-lg lg:text-xl font-bold mb-2 lg:mb-3 text-gray-900">{value.title}</h3>
      ...
      {/* Leadership Team - Responsive Design */}
      <section className="py-12 lg:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 lg:mb-20">
            <div className="inline-block mb-6 lg:mb-8">
              <div className="flex items-center gap-2">
                <div className="w-2 lg:w-3 h-2 lg:h-3 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full animate-ping"></div>
                <span className="text-xs lg:text-sm font-semibold text-emerald-600 tracking-widest">LEADERSHIP TEAM</span>
                <div className="w-2 lg:w-3 h-2 lg:h-3 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full animate-ping" style={{ animationDelay: '0.3s' }}></div>
              </div>
            </div>

            <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold mb-4 lg:mb-6 relative">
              <span className="relative z-10">
                <span className="text-gray-900">Our</span>
                <span className="ml-2 lg:ml-4 text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">
                  Leaders
                </span>
              </span>
            </h2>
          ...
          <div className="lg:hidden flex flex-col gap-8 lg:gap-16 max-w-md mx-auto">
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div>
                      ...
                      <div className="h-1.5 w-16 mx-auto mt-3 bg-gradient-to-r from-emerald-400 to-teal-400"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Desktop Layout - Horizontal Gallery */}
          <div className="hidden lg:block relative max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
              {/* MD Card - Left Side */}
              <div className="lg:w-2/5 order-2 lg:order-1">
                <div className="relative w-full max-w-[450px] mx-auto lg:mx-0 lg:ml-auto group">
                  <div className="relative pb-[100%] rounded-3xl overflow-hidden shadow-2xl">
                    <div className="absolute inset-0">
                      <Image
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-10">
                      <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        <h3 className="text-3xl font-bold text-white mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                          {teamMembers[1].name}
                        </h3>
                        <p className="text-blue-300 font-medium text-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                          Managing Director
                        </p>
                        <div className="h-1.5 w-0 mx-auto mt-4 bg-gradient-to-r from-blue-400 to-cyan-400 group-hover:w-32 transition-all duration-700 delay-150"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:w-3/5 order-1 lg:order-2 z-10">
                <div className="relative w-full max-w-[600px] mx-auto group">
                  <div className="relative pb-[100%] rounded-[3rem] overflow-hidden shadow-3xl">
                    <div className="absolute inset-0">
                      <Image
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-12">
                      <div className="text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        <h3 className="text-4xl font-bold text-white mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                          {teamMembers[0].name}
                        </h3>
                        <p className="text-emerald-300 font-medium text-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                          Whole Time Director
                        </p>
                        <div className="h-1.5 w-0 mx-auto mt-6 bg-gradient-to-r from-emerald-400 to-teal-400 group-hover:w-40 transition-all duration-700 delay-150"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:w-2/5 order-3">
                <div className="relative w-full max-w-[450px] mx-auto lg:mx-0 lg:mr-auto group">
                  <div className="relative pb-[100%] rounded-3xl overflow-hidden shadow-2xl">
                    <div className="absolute inset-0">
                      <Image
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-10">
                      <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        ...
                        <p className="text-purple-300 font-medium text-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                          Whole Time Director
                        </p>
                        <div className="h-1.5 w-0 mx-auto mt-4 bg-gradient-to-r from-purple-400 to-pink-400 group-hover:w-32 transition-all duration-700 delay-150"></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* Leadership Quote */}
          <div className="max-w-4xl mx-auto mt-12 lg:mt-24 text-center">
            <div className="relative group cursor-pointer">
              <div className="text-4xl lg:text-6xl text-emerald-100 absolute -top-4 lg:-top-8 left-1/2 transform -translate-x-1/2 group-hover:text-emerald-200 transition-colors duration-300">"</div>
              <p className="text-lg lg:text-3xl text-gray-800 italic font-light relative z-10 group-hover:text-gray-900 transition-colors duration-300">
              ...
              <div className="text-4xl lg:text-6xl text-emerald-100 absolute -bottom-8 lg:-bottom-12 left-1/2 transform -translate-x-1/2 group-hover:text-emerald-200 transition-colors duration-300">"</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section className="py-12 lg:py-20 bg-gradient-to-r from-blue-50 via-white to-emerald-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 lg:mb-12">
              <div className="inline-flex items-center gap-3 px-4 py-2 lg:px-6 lg:py-3 bg-gradient-to-r from-blue-100 to-emerald-100 rounded-full mb-6 lg:mb-8 shadow-lg">
                <FaHandshake className="text-blue-600 text-sm lg:text-base" />
                <span className="text-blue-700 font-semibold text-sm lg:text-base">LET&apos;S BUILD TOGETHER</span>
              </div>

              <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-4 lg:mb-6 text-gray-900">
              ...
              <p className="text-gray-700 mb-8 lg:mb-12 max-w-2xl mx-auto text-sm lg:text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              <div className="relative group bg-white rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-600 to-cyan-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                <div className="flex items-center gap-4 mb-4 lg:mb-6">
                  <div className="p-3 lg:p-4 bg-blue-100 rounded-xl shadow-sm">
                    <FaMapMarkerAlt className="text-xl lg:text-2xl text-blue-600" />
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900">Main Office Address</h3>
                </div>
              ...
              <div className="relative group bg-white rounded-xl lg:rounded-2xl p-6 lg:p-8 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="flex items-center gap-4 mb-4 lg:mb-6">
                  <div className="p-3 lg:p-4 bg-purple-100 rounded-xl shadow-sm">
                    <FaEnvelope className="text-xl lg:text-2xl text-purple-600" />
                  </div>
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900">Email Address</h3>
                </div>
            ...
            <div className="text-center mt-8 lg:mt-12">
              <button 
                data-cal-namespace="shiv-enterprises"
                data-cal-link="abhishek-dwivedi-uvvvno/shiv-enterprises"
                data-cal-config='{"layout":"month_view"}' 
                className="group px-8 py-3 lg:px-12 lg:py-4 bg-gradient-to-r from-blue-600 via-blue-700 to-emerald-600 text-white font-bold rounded-xl hover:rounded-2xl hover:shadow-xl hover:shadow-blue-500/30 transform hover:-translate-y-1 transition-all duration-300 text-base lg:text-lg shadow-lg w-full sm:w-auto"
              >
